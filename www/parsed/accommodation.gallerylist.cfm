...
<!--- fuseaction: galleryList --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "accommodation">
<cfset myFusebox.thisFuseaction = "galleryList">
...
<cfif not isDefined("attributes.gal_id")><cfset attributes.gal_id = "16" /></cfif>
...
<cfset myFusebox.thisCircuit = "accommodation">
<cfset myFusebox.thisFuseaction = "galleryList">
<cfset content.gallery = application.imageObj.displayGallery(attributes.gal_id) >
<cfset content.mainContent = "#content.mainContent##content.gallery#" />
<cfset content.mainContent = application.imageObj.displayGalleryList(attributes.gal_id) >
