...
<cfloop query="qSiteContent">
   <url>
      <loc><cfif con_type is "Content" and not len(con_fuseAction)>http://www.theelysian.com/index.cfm?page=#con_sanitise#<cfelseif con_type is "Content" and len(con_fuseAction)>http://www.theelysian.com/index.cfm?fuseaction=#con_fuseAction#&amp;page=#con_sanitise#<cfelseif con_type is "Link">#con_link#</cfif></loc>
